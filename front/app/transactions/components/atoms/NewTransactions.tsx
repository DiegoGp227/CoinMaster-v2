  ...
  return (
    <div className="flex justify-center">
      <button
        ...
        className="w-[320px] h-[140px] bg-black rounded-[5px] flex justify-center items-center border-2 hover:border-soft-gray hover:shadow-[0_0_10px_2px_rgba(156,163,175,0.3)] group transition-all duration-500 gap-3"
      >
